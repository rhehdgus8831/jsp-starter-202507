...
public class DancerRepository {
    ...
    static {
        dancerList = new ArrayList<>(List.of(
                new Dancer("춘식이","카카오프렌즈",DanceLevel.AMATEUR, List.of(Genre.HIPHOP,Genre.HIPHOP)),
                new Dancer("폼폼푸린","산리오친구들",DanceLevel.BEGINNER, List.of(Genre.STREET,Genre.HIPHOP)),
